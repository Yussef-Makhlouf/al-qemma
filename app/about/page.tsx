      ...
      <section className="bg-white py-16 sm:py-24 text-[#0D1B35] flex flex-col lg:flex-row relative overflow-hidden">
          <div className="w-full lg:w-1/2 px-4 sm:px-6 lg:px-12 flex flex-col justify-center z-10">
             ...
             <div className="space-y-6 text-[#4A5568] leading-relaxed font-light text-base sm:text-lg text-justify">
                ...
                <p>
                  بدأنا رحلتنا بفريق صغير من الخبراء المتحمسين للتميز في الرياض، ومع مرور الوقت والالتزام الصارم بمعايير الجودة، تطورنا بفضل الله ثم بثقة عملائنا لنُغطي اليوم ست مدن رئيسية في المملكة. نخدم أكثر من ٥٠٠ منشأة تجارية وآلاف المنازل السكنية بأسطول كبير وفرق مؤهلة خضعت لأدق الفحوصات الأمنية والطبية.
                </p>
                <p>

...
export const metadata: Metadata = {
  title: 'خدمات شركة القمة للتنظيف الاحترافية في الخبر',
  description: 'شركة القمة الفريدة – ١٦ خدمة تنظيف احترافية في الخبر. تنظيف منازل وفلل وشقق، كنب وسجاد وموكيت، مطابخ وحمامات وخزانات، تعقيم وتنظيف عميق. نخدم الخبر بالكامل. اتصل: 0545359694.',
  alternates: {
...
const services = [
  {
    ...
    imageAlt: "تنظيف منازل احترافي في الخبر",
    title: "تنظيف المنازل في الخبر – نتيجة تراها قبل ما يغادر فريقنا",
  ...
  },
  {
    ...
    imageAlt: "تنظيف فلل في الخبر",
    title: "تنظيف الفلل في الخبر – لأن الفيلا الكبيرة تحتاج فريق يفهم حجمها",
  ...
  },
  {
    ...
    imageAlt: "تنظيف شقق في الخبر",
    title: "تنظيف الشقق في الخبر – سريع، دقيق، وبسعر يناسبك",
  ...
  },
  {
    ...
    imageAlt: "تنظيف سجاد بالبخار في الخبر",
    title: "تنظيف السجاد في الخبر – البقع تروح، الألوان ترجع",
  ...
  },
  {
    ...
    icon: Sofa,
    image: "/professional-cleaning.png",
    imageAlt: "تنظيف كنب في الخبر",
    title: "تنظيف الكنب في الخبر – الكنب الجديد ما تحتاج يكون جديداً",
  ...
  },
  {
    ...
    icon: Sparkles,
    image: "/home-disinfection.png",
    imageAlt: "تنظيف مجالس في الخبر",
    title: "تنظيف المجالس في الخبر – المجلس السعودي له مكانة تستحق عناية حقيقية",
  ...
  },
  {
    ...
    icon: Layers,
    image: "/carpet-cleaning.avif",
    imageAlt: "تنظيف موكيت بالبخار في الخبر",
    title: "تنظيف الموكيت بالخبر – حل نهائي لما تجمع من أتربة وروائح",
  ...
  },
  {
    ...
    icon: FlameKindling,
    image: "/professional-cleaning.png",
    imageAlt: "تنظيف مطابخ في الخبر",
    title: "تنظيف المطابخ في الخبر – الدهون والبخار ما يصمدون أمام فريقنا",
  ...
  },
  {
    ...
    icon: ShieldCheck,
    image: "/home-disinfection.png",
    imageAlt: "تنظيف وتعقيم حمامات في الخبر",
    title: "تنظيف الحمامات في الخبر – تعقيم كامل، مو بس مسح",
  ...
  },
  {
    ...
    imageAlt: "تنظيف خزانات مياه في الخبر",
    title: "تنظيف خزانات المياه في الخبر – المياه اللي تشربها تبدأ من هنا",
  ...
  },
  {
    ...
    imageAlt: "تنظيف زجاج ونوافذ في الخبر",
    title: "تنظيف الزجاج في الخبر – شفافية تامة، بدون بقع أو خدوش",
  ...
  },
  {
    ...
    icon: HardHat,
    image: "/clean-villa.png",
    imageAlt: "تنظيف بعد التشطيب في الخبر",
    title: "تنظيف بعد التشطيب في الخبر – المنزل الجديد يستحق بداية نظيفة",
  ...
  },
  {
    ...
    icon: Building2,
    image: "/commercial-cleaning.png",
    imageAlt: "تنظيف مكاتب في الخبر",
    title: "تنظيف المكاتب في الخبر – بيئة عمل نظيفة تفرق في الإنتاجية",
  ...
  },
  {
    ...
    icon: ShieldCheck,
    image: "/home-disinfection.png",
    imageAlt: "تعقيم وتطهير منازل في الخبر",
    title: "تعقيم وتطهير المنازل في الخبر – نظافة مرئية وحماية غير مرئية",
  ...
  },
  {
    ...
    icon: Sparkles,
    image: "/eco-friendly-cleaning-solutions.png",
    imageAlt: "تنظيف عميق شامل في الخبر",
    title: "تنظيف عميق في الخبر – للأماكن اللي احتاجت وقتاً طويلاً بدون عناية",
  ...
  },
  {
    ...
    imageAlt: "إزالة روائح من المنازل في الخبر",
    title: "إزالة الروائح من المنازل في الخبر – مو مجرد عطر يغطي، نزيل المصدر",
      ...
      <section className="relative min-h-[40vh] sm:h-[50vh] flex flex-col justify-center overflow-hidden bg-[#0D1B35] pt-24 pb-16">
        ...
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 relative z-10 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6">
            خدماتنا <span className="text-gold">في الخبر</span>
          </h1>
          <p className="text-white/70 max-w-2xl mx-auto text-lg sm:text-xl font-light leading-relaxed">
            نقدم مجموعة شاملة من خدمات التنظيف الاحترافية في الخبر، مصممة بدقة لتلبية أعلى معايير الجودة والسلامة لمنزلك أو منشأتك.
          </p>
        </div>
      </section>
...
const faqs = [
  ...
  { q: 'ما هي مناطق التغطية الجغرافية لخدمات شركة القمة؟', a: 'نغطي حالياً الخبر بشكل حصري بفرق عمل متخصصة لضمان سرعة الاستجابة وجودة الخدمة. تركيزنا الكامل على الخبر يضمن لك خدمة أسرع ومتابعة أفضل.', },
];

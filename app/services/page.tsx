...
export const metadata: Metadata = {
  title: 'خدمات شركة القمة للتنظيف الاحترافية في الدمام',
  description: 'شركة القمة الفريدة – ١٦ خدمة تنظيف احترافية في الدمام. تنظيف منازل وفلل وشقق، كنب وسجاد وموكيت، مطابخ وحمامات وخزانات، تعقيم وتنظيف عميق. نخدم الدمام بالكامل. اتصل: 0545359694.',
  alternates: {
...
const services = [
  {
    ...
    imageAlt: "تنظيف منازل احترافي في الدمام",
    title: "تنظيف المنازل في الدمام – نتيجة تراها قبل ما يغادر فريقنا",
  ...
  },
  {
    ...
    imageAlt: "تنظيف فلل في الدمام",
    title: "تنظيف الفلل في الدمام – لأن الفيلا الكبيرة تحتاج فريق يفهم حجمها",
  ...
  },
  {
    ...
    imageAlt: "تنظيف شقق في الدمام",
    title: "تنظيف الشقق في الدمام – سريع، دقيق، وبسعر يناسبك",
  ...
  },
  {
    ...
    imageAlt: "تنظيف سجاد بالبخار في الدمام",
    title: "تنظيف السجاد في الدمام – البقع تروح، الألوان ترجع",
  ...
  },
  {
    ...
    icon: Sofa,
    image: "/professional-cleaning.png",
    imageAlt: "تنظيف كنب في الدمام",
    title: "تنظيف الكنب في الدمام – الكنب الجديد ما تحتاج يكون جديداً",
  ...
  },
  {
    ...
    icon: Sparkles,
    image: "/home-disinfection.png",
    imageAlt: "تنظيف مجالس في الدمام",
    title: "تنظيف المجالس في الدمام – المجلس السعودي له مكانة تستحق عناية حقيقية",
  ...
  },
  {
    ...
    icon: Layers,
    image: "/carpet-cleaning.avif",
    imageAlt: "تنظيف موكيت بالبخار في الدمام",
    title: "تنظيف الموكيت بالدمام – حل نهائي لما تجمع من أتربة وروائح",
  ...
  },
  {
    ...
    icon: FlameKindling,
    image: "/professional-cleaning.png",
    imageAlt: "تنظيف مطابخ في الدمام",
    title: "تنظيف المطابخ في الدمام – الدهون والبخار ما يصمدون أمام فريقنا",
  ...
  },
  {
    ...
    icon: ShieldCheck,
    image: "/home-disinfection.png",
    imageAlt: "تنظيف وتعقيم حمامات في الدمام",
    title: "تنظيف الحمامات في الدمام – تعقيم كامل، مو بس مسح",
  ...
  },
  {
    ...
    imageAlt: "تنظيف خزانات مياه في الدمام",
    title: "تنظيف خزانات المياه في الدمام – المياه اللي تشربها تبدأ من هنا",
  ...
  },
  {
    ...
    imageAlt: "تنظيف زجاج ونوافذ في الدمام",
    title: "تنظيف الزجاج في الدمام – شفافية تامة، بدون بقع أو خدوش",
  ...
  },
  {
    ...
    icon: HardHat,
    image: "/clean-villa.png",
    imageAlt: "تنظيف بعد التشطيب في الدمام",
    title: "تنظيف بعد التشطيب في الدمام – المنزل الجديد يستحق بداية نظيفة",
  ...
  },
  {
    ...
    icon: Building2,
    image: "/commercial-cleaning.png",
    imageAlt: "تنظيف مكاتب في الدمام",
    title: "تنظيف المكاتب في الدمام – بيئة عمل نظيفة تفرق في الإنتاجية",
  ...
  },
  {
    ...
    icon: ShieldCheck,
    image: "/home-disinfection.png",
    imageAlt: "تعقيم وتطهير منازل في الدمام",
    title: "تعقيم وتطهير المنازل في الدمام – نظافة مرئية وحماية غير مرئية",
  ...
  },
  {
    ...
    icon: Sparkles,
    image: "/eco-friendly-cleaning-solutions.png",
    imageAlt: "تنظيف عميق شامل في الدمام",
    title: "تنظيف عميق في الدمام – للأماكن اللي احتاجت وقتاً طويلاً بدون عناية",
  ...
  },
  {
    ...
    imageAlt: "إزالة روائح من المنازل في الدمام",
    title: "إزالة الروائح من المنازل في الدمام – مو مجرد عطر يغطي، نزيل المصدر",
      ...
      <section className="relative min-h-[40vh] sm:h-[50vh] flex flex-col justify-center overflow-hidden bg-[#0D1B35] pt-24 pb-16">
        ...
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 relative z-10 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-6">
            خدماتنا <span className="text-gold">في الدمام</span>
          </h1>
          <p className="text-white/70 max-w-2xl mx-auto text-lg sm:text-xl font-light leading-relaxed">
            نقدم مجموعة شاملة من خدمات التنظيف الاحترافية في الدمام، مصممة بدقة لتلبية أعلى معايير الجودة والسلامة لمنزلك أو منشأتك.
          </p>
        </div>
      </section>
...
const faqs = [
  ...
  { q: 'ما هي مناطق التغطية الجغرافية لخدمات شركة القمة؟', a: 'نغطي حالياً الدمام بشكل حصري بفرق عمل متخصصة لضمان سرعة الاستجابة وجودة الخدمة. تركيزنا الكامل على الدمام يضمن لك خدمة أسرع ومتابعة أفضل.', },
];

...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    // القصيم
    'شركة تنظيف القصيم', 'تنظيف منازل القصيم', 'غسيل كنب القصيم', 'تنظيف فلل القصيم',
    // مكه
    'شركة تنظيف مكه', 'تنظيف منازل مكه', 'غسيل كنب مكه', 'تنظيف فلل مكه',
    // الخبر
    'شركة تنظيف الخبر', 'تنظيف منازل الخبر', 'غسيل كنب الخبر', 'تنظيف فلل الخبر',
    // الجبيل
    'شركة تنظيف الجبيل', 'تنظيف منازل الجبيل', 'غسيل كنب الجبيل', 'تنظيف فلل الجبيل',
    // ابها
    'شركة تنظيف ابها', 'تنظيف منازل ابها', 'غسيل كنب ابها', 'تنظيف فلل ابها',
    // جازان
    'شركة تنظيف جازان', 'تنظيف منازل جازان', 'غسيل كنب جازان', 'تنظيف فلل جازان',
    // نجران
    'شركة تنظيف نجران', 'تنظيف منازل نجران', 'غسيل كنب نجران', 'تنظيف فلل نجران',
    // حائل
    'شركة تنظيف حائل', 'تنظيف منازل حائل', 'غسيل كنب حائل', 'تنظيف فلل حائل',
  ...
  openGraph: {
    ...
    siteName: 'القمة لخدمات النظافه في السعوديه',
    title: 'القمة لخدمات النظافه في السعوديه | شركة تنظيف رائدة في السعودية',
    description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'شركة القمة لخدمات النظافه في السعوديه',
      },
      {
        url: '/icon.png',
        width: 1200,
  ...
  twitter: {
    ...
    title: 'القمة لخدمات النظافه في السعوديه | السعودية',
